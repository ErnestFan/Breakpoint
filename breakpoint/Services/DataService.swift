...
class DataService {
    ...
    func getAllMessages(forDesiredGroup group: Group, handler: @escaping (_ messagesArray: [Message]) -> ()) {
        ...
        REF_GROUPS.observeSingleEvent(of: .value) { (groupSnapshot) in
            ...
            for group in groupSnapshot {
                ...
                if memberArray.contains((Auth.auth().currentUser?.uid)!) {
                    ...
                    let key = group.key
                    let group = Group(title: title, description: description, key: key, memberCount: memberArray.count, members: memberArray)
